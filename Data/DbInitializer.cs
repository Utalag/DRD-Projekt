...

        {
            ...
            var weapon = new Weapon[]
           {
                new ()
                {
                   ...
                   UT           = 0,
                   OZ           = 0,
                   ClassWeapon  = WeaponClassEnum.contact,
                   SizeWeapon   = WeaponSizeEnum.light,
                   TypeWeapon   = WeaponTypeEnum.striking,
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 1,
                   LengthWeapon = 0,
                   InitiativeWeapon = 0,
                },
                new ()
                ...
                new ()
                {
                   ...
                   UT           = 2,
                   OZ           = 2,
                   ClassWeapon  = WeaponClassEnum.oneHanded,
                   SizeWeapon   = WeaponSizeEnum.light,
                   TypeWeapon   = WeaponTypeEnum.stab,
                   Metal        = "Železo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 1,
                   WeightWeapon = 5,
                ...
                new ()
                {
                   ...
                   ClassWeapon  = WeaponClassEnum.oneHanded,
                   SizeWeapon   = WeaponSizeEnum.light,
                   TypeWeapon   = WeaponTypeEnum.cut,
                   Metal        = "Železo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 3,
                   WeightWeapon = 12,
                   Price = 4,
                ...
                new ()
                {
                   ...
                   OZ           = 5,
                   ClassWeapon  = WeaponClassEnum.oneHanded,
                   SizeWeapon   = WeaponSizeEnum.medium,
                   TypeWeapon   = WeaponTypeEnum.cut,
                   Metal        = "Železo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 7,
                   WeightWeapon = 25,
                   Price = 32,
                ...
                new ()
                {
                   ...
                   ClassWeapon  = WeaponClassEnum.oneHanded,
                   SizeWeapon   = WeaponSizeEnum.medium,
                   TypeWeapon   = WeaponTypeEnum.crushing,
                   Metal        = "Dřevo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 8,
                   WeightWeapon = 35,
                   Price = 8,
                ...
                new ()
                {
                   NameWeapon   = "Meč bastard",
                   SZ           = 6,
                   UT           = 10,
                   OZ           = 6,
                   ClassWeapon  = WeaponClassEnum.oneHanded,
                   SizeWeapon   = WeaponSizeEnum.heavy,
                   TypeWeapon   = WeaponTypeEnum.cut,
                   Metal        = "Železo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 12,
                   WeightWeapon = 40,
                   Price = 32,
                ...
                new ()
                {
                   ...
                   UT           = 4,
                   OZ           = 4,
                   ClassWeapon  = WeaponClassEnum.twoHanded,
                   SizeWeapon   = WeaponSizeEnum.light,
                   TypeWeapon   = WeaponTypeEnum.crushing,
                   Metal        = "dřevo",
                   ControlAttribute = AtributEnum.strength,
                ...
                new ()
                {
                   NameWeapon   = "Krátký luk",
                   SZ           = 3,
                   UT           = 0,
                   OZ           = 3,
                   ClassWeapon  = WeaponClassEnum.firearm,
                   SizeWeapon   = WeaponSizeEnum.medium,
                   TypeWeapon   = WeaponTypeEnum.stab,
                   Metal        = "dřevo",
                   ControlAttribute = AtributEnum.strength,
                   MinimalControllability = 6,
                   WeightWeapon = null,
                   Price = 2,
            ...
            context.Weapon.AddRange(weapon);
            context.SaveChanges();
        }
    }
}
